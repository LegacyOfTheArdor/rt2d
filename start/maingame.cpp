/**
 * This class describes MainGame behavior.
 *
...
void MainGame::update(float deltaTime)
{
	...
	for(int i = 0; i <pointTiles.size(); i++)
	{
		if(pointTiles[i]->sprite()->color == RGBAColor(0, 241, 255, 255))
		{
			playerOnescore++;
			
		}
		else if(pointTiles[i]->sprite()->color == RGBAColor(255, 0, 255, 255))
		{
			playerTwoscore++;
		}
	}
